...
float averageElements(int arr[], int arrLength){
    return (float) sumElements(arr, arrLength) / arrLength;
}
...
int main() {
    ...
    cout << "Average of elements: " << averageElements(arr, arrLength) << endl;
    return 0; 
